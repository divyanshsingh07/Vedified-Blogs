...
const WelcomeNote = () => {
    return (
        <div className='flex justify-center items-center flex-col py-16 px-6 bg-gradient-to-br from-white via-white to-gray-100 relative overflow-hidden'>
            ...
            {/* Main Heading */}
            <h1 className='text-center bg-gradient-to-r from-slate-900 via-slate-800 to-slate-700 bg-clip-text text-transparent text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight tracking-tight'>
  Welcome to Our Blog
</h1>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl mt-8'>
                <div className='group p-6 bg-white/70 backdrop-blur-sm rounded-2xl border border-gray-200 hover:border-teal-400 hover:shadow-xl transition-all duration-300 hover:-translate-y-1'>
                    ...
                    <h3 className='font-bold text-navy-800 text-lg mb-2 group-hover:text-teal-600 transition-colors duration-300'>
                        Fresh Ideas
                    </h3>
