    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <button 
          ...
          className="mt-4 sm:mt-0 bg-blue-600 text-white px-3 sm:px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors text-sm sm:text-base"
        >
          Add New Blog
        </button>
      </div>
          ...
          {filteredBlogs.map((blog, index) => (
            <div key={blog._id} className="p-3 sm:p-4 border-b border-gray-200 last:border-b-0">
              ...
              <div className="flex gap-2">
                ...
                <button className="flex-1 text-blue-600 hover:text-blue-800 bg-blue-100 hover:bg-blue-200 px-3 py-2 rounded-md text-xs font-medium transition-colors">
                  Edit
                </button>
                <button 
                ...
                <tr key={blog._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div className="flex gap-2">
                      ...
                      <button className="text-blue-600 hover:text-blue-800 bg-blue-100 hover:bg-blue-200 px-3 py-1 rounded-md text-xs transition-colors">
                        Edit
                      </button>
                      <button 
                        onClick={() => handleDelete(blog._id)}
